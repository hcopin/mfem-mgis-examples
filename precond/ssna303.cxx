...
int main(int argc, char** argv) {
  ...
  //file creation 
  std::string const myFile("/home/hc265945/spack_codes/mfem-mgis/ssna303/ssna303-3D/Test_Ssna303/HypreBoomerAMG/HypreGMRES/HGMRES_test.txt");
...
//                           {"Strategy", "Elasticity"},
  ...
  problem.addPostProcessing("ParaviewExportResults",
                            {{"OutputFileName", std::string("ssna303-displacements-HGMRES_HBAMG_1")}});
  problem.addPostProcessing("ComputeResultantForceOnBoundary",
                            {{"Boundary", 2}, {"OutputFileName", "force_HGMRES_HBAMG_1.txt"}});
