...
int main(int argc, char** argv) {
  ...
  //file creation 
  std::string const myFile("/home/hc265945/spack_codes/mfem-mgis/ssna303/ssna303-3D/Test_Ssna303/Without_Preconditioner/SLISolver/SLISolver.txt");
...
//                           {"Strategy", "Elasticity"},
  ...
  problem.addPostProcessing("ParaviewExportResults",
                            {{"OutputFileName", std::string("ssna303-displacements-SLI_WP_0")}});
  problem.addPostProcessing("ComputeResultantForceOnBoundary",
                            {{"Boundary", 2}, {"OutputFileName", "force_SLI_WH_0.txt"}});
